...
public class TextArchive {
    private String introText = "Ano 2073, a guerra entre Ases e Coringas está em seu pior momento.\n"
            +"Você é um capitão do exército de Ases, e foi capturado ao tentar plantar um dispositivo secreto em uma base Coringa.\n"
            +"Agora sua missão é tentar escapar da base e destrui-la";
    private String celaText = "Você se encontra em sua cela, e está estudando suas opções.\n"
            +"A sua frente encontra-se a porta que é protegida por um código, a sua esquerda(oeste)encontra-se uma parede, igualmente para o lado direito(leste)."
            +"Porém quando estava quase desistindo, você se lembra que tem um mini decodificador dentro da sola de seu sapato.";
